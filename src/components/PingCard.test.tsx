...
describe("PingCard", () => {
  it("shows completed Vote totals without voter-to-ballot mappings", () => {
    ...
    const { container } = render(<PingCard ping={ping} responses={responses} currentPlayer={gm} role="GM" settings={DEFAULT_SETTINGS} metadata={{}} now={4} onReply={() => undefined} onChanged={() => undefined} />);
