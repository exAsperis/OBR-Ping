...
const failures = [];
if (readConstant("EXTENSION_NAME") !== "Ping") failures.push("EXTENSION_NAME must be Ping");
...
if (manifest.name !== "Ping" || local.name !== "Ping (Local)") failures.push("manifest names are incorrect");
